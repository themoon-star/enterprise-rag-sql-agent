...
|---|---|---|
| M0 Clean-room repository | Complete | Empty-directory Git initialization; no remote; boundary and architecture documented |
| M1 Tenant and RAG backend | Not started | Focused unit/integration tests |
...
- [ ] Verified tenant tokens and cross-tenant 404 behavior.
- [ ] RAG ACL-before-ranking, refusal, clarification and citations.
